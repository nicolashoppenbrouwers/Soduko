...
public class GetMaximumActionPoints extends Expression<DoubleLiteral>{

	public GetMaximumActionPoints(int line, int column, Expression<Entity> e){
		super(line,column);
	...
	public DoubleLiteral evaluate(Program program) {
		...
		return new DoubleLiteral(getLine(),getColumn(),worm.getMaximumActionPoints());
	}
}
